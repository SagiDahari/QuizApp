    ...
    viewModel.questions.collectAsState().value.let { questions ->
        if (questions.isNotEmpty()) {
            ...
            Column(
                ...
                // Shuffling the answers (generated by chatGPT)
                ...
                LazyColumn(
                    ...
                    items(allAnswers) { answer ->
                        // Determine the background color based on the answer (generated by chatGPT)
...
fun SettingsScreen(viewModel: QuizViewModel, navController: NavHostController) {
    ...
    Column(
        ...
        // Difficulty Dropdown (generated by chatGPT)
        ...
        // Category Dropdown (generated by chatGPT)
        ExposedDropdownMenuBox(
